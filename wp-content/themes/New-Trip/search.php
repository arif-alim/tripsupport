    ...
    <main>
        <div class="bg-white">
            <div class="relative pb-28 lg:pb-20 bg-gray-800">
                ...
                <div class="relative max-w-7xl mx-auto py-12 px-4 sm:py-32 sm:px-6 lg:px-8 text-center"><h1
                            ...
                            <section class="relative mb-6 px-4">
                                <div class="text-left">
                                    <div class="sm:flex sm:items-baseline sm:justify-between"><h1
                                            ...
                                            <span class="block xl:inline">Search Result : <?php echo get_search_query(); ?></span>
                                        </h1></div>
                                   </div>
                            </section>
                                                ...
                                                <div class="w-full lg:w-[64%] p-6 lg:py-6 lg:px-8"><h4
                                                    ...
                                                    <div class="mt-6 flex items-center justify-between">
                                                        <div class="inline-flex flex-shrink-0"><a href="#">
                                                            ...
                                                            <div class="ml-3"><p class="text-sm font-medium text-gray-900"><a
                                                                        href="#" class="hover:underline"><?php the_author() ?></a></p>
