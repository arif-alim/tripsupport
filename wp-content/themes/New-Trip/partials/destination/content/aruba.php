      ...
      <div class="d-flex d-flex-wrap">
        <div class="w-full">
          <h1 class="text-xl tracking-tight font-extrabold text-slate-900 sm:text-2xl md:text-3xl"> 
            <span class="block xl:inline">About Oranjestad, <?php the_title(); ?></span>
          </h1>
        </div>
      </div>
      <div class="max-w-5xl py-4 prose">
        <p>
          Aruba is a tropical island in the Southern Caribbean known for its impeccable beaches and amazing resorts with an abundance of all-inclusive and 5-star options. Aruba has been said to be one of the safest islands of the Caribbean with a low crime rate and steady tourism economy. It is part of the Lesser Antilles islands located near the coast of Venezuela. When it is clear, visitors can even see the coast of Venezuela.
        </p>
        <p>
          Aruba is a constituent country of the Netherlands and sees many European visitors, US visitors, and South American visitors. There are worldwide flights into Aruba, as well as cruise ships that port for the day. Aruba can have long periods of drought, which does not allow for a lot of vegetation. Instead, Aruba is known for its white sand and incredible beaches. Its world-famous beach, Eagle Beach, has been called one of the best beaches in the world by TripAdvisor, Earthtrekkers, and more. This has made a sought-after travel destination for honeymooners, retirees, families, and those looking to unplug on the beach. With Book Now, Pay Later you can plan your vacation to one of the best beaches in the entire world.
        <p>
      </div>
      ...
      <div class="flex gap-4 lg:gap-8 mt-4 lg:mt-8 h-[500px]">
          ...
          <div id="carouselExampleCrossfade" class="carousel slide carousel-fade relative " data-bs-ride="carousel">
            ...
            <div class="carousel-inner relative w-full overflow-hidden rounded-lg ">
              <div class="carousel-item active float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/aruba-2.jpg'?>"
              ...
              <div class="carousel-item float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/aruba-1.jpg'?>"
                  class="block w-full object-cover object-center"
                  alt="Camera"
                />
              </div>
              <div class="carousel-item float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/aruba-3.jpg'?>"
                  class="block w-full object-cover object-center"
                  alt="Exotic Fruits"
                />
              </div>
        ...
        <div class="flex-col sm:w-1/2 space-y-4 h-[500px]">
          ...
          <div class="flex justify-start items-center space-x-12">
            <?php echo do_shortcode("[location-weather id='11336']"); ?>
