<div class="ts-d-flex ts-m-block">
    <div class="ts-col-half ts-col-m-full  ts-pr ts-py-m ts-vacation-from-container">
        <input id="vacation-from-desktop" name="vacation-from-desktop" type="text" placeholder="Departing From?">
    </div>
    <div class="ts-col-half ts-col-m-full ts-pl ts-pl-m ts-py-m ts-vacation-go-to-container">
            ...
            <div class="ts-col-half ts-pl-half ">
                <div class="ts-dropdown">
                    ...
                    <div class="ts-select ts-select-custom">
                        <span class="ts-vacation-display-duration">3 or 4 days</span>
                    </div>
                    ...
                    <ul class="ts-vacation-ul-duration ts-dropdown-menu">
                        ...
                        <li id="5,6,7,8,9,10">5 or 10 days</li>
                        <li id="14,15">14 or 15 days</li>
                        <li id="11,12,13,14,15,16">11 or 16 days</li>
                        <li id="17,18,19,20,21,22">17 or 22 days</li>
                        <li id="1">1 day</li>
                        <li id="2">2 days</li>
                        <li id="3">3 days</li>
                        <li id="4">4 days</li>
        ...
        <div class="ts-d-flex ts-py-m">
            <div class="ts-col-half ts-pr-half">
                <div class="ts-dropdown">
                    ...
                    <div class="ts-select ts-select-custom">
                        <span id="ts-vacation-display-rooms">1</span>
                    </div>
                    <input type="hidden" name="gender" id="ts-vacation-value-rooms">
