        ...
        <div class="space-y-16 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700"
                               aria-current="page"><?php the_title() ?></a></div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="prose prose-slate prose-lg mx-auto">
                <div class="text-left">
                    ...
                    <div class="text-base md:text-md md:leading-relaxed font-medium text-gray-600 lg:w-2/3"><a
                                href="javascript:void(0)" class="text-pblue-700 hover:text-pblue-400"><?php the_author() ?></a> on
                        <span class="font-semibold"><?php the_time('M j , Y') ?></span> · <?php global $post; reading_time_article($post->post_content) ?> read
                    </div>
                </div>
            </div>
            ...
            <article class="prose prose-slate prose-lg mx-auto">
                <div class="object-cover w-full">
                    <img src="<?php the_post_thumbnail_url() ?>"
                                                      ...
                                                      class="rounded w-full object-cover aspect-[5/2]"></div>
        ...
        <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
            <div class="flex flex-col md:flex-row md:items-center space-y-16 md:space-y-0 md:space-x-28">
                <div class="relative">
                    ...
                    <img src="<?php echo THEME_IMAGE_HOME.'/blog-post-1.jpg'?>" alt="Hero Image"
                         class="relative rounded-lg mx-auto shadow-lg w-full object-cover aspect-[5/2]"></div>
                ...
                <div class="space-y-10 w-full">
                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-2"><a
                            ...
                            <svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                 class="opacity-50 hi-solid hi-check inline-block w-5 h-5">
