<template>
  ...
  >
    ...
    <div
      class="vhd__datepicker__dummy-wrapper"
      ...
      <div class="vhd__hide-on-desktop">
        ...
        >
          <div
            ...
            tabindex="0"
            :class="{
              'vhd__datepicker__dummy-input--is-active':
                isOpen && checkIn == null,
            }"
            type="button"
          >
          {{ `${checkIn ? dateFormater(checkIn) : checkInTitle}` }}
          </div>
          <div
            class="vhd__datepicker__input"
            tabindex="0"
            ...
            type="button"
          >
            {{ `${checkOut ? dateFormater(checkOut) : checkOutTitle}` }}
          </div>
        </div>
      </div>
      <div v-if="isOpen || alwaysVisible" class="vhd__datepicker__inner">
        ...
        <div
          ...
          :class="[
            ...
            { 'vhd__show-tooltip': showCustomTooltip && hoveringTooltip },
          ]"
        >
  ...
  methods: {
    ...
    renderPreviousMonth() {
      if (this.activeMonthIndex >= 1) {
        const firstDayOfLastMonth = this.months[
