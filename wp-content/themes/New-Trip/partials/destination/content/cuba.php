      ...
      <div class="d-flex d-flex-wrap -mx-4">
        <div class="w-full px-4">
          <h1 class="text-xl tracking-tight font-extrabold text-slate-900 sm:text-2xl md:text-3xl"> 
            <span class="block xl:inline">About Havana, <?php the_title(); ?></span>
          </h1>
        </div>
      </div>
      <div class="max-w-5xl py-4 prose">
        <p>
          Tired of spending more time researching flights than actually enjoying your vacation? Research shows the average customer visits 38 sites before booking a trip. At Trip Support, we think we all have better ways to spend our time. Our <a href="<?php echo home_url() ?>/book-now-pay-later">Book Now Pay Later</a> flight makes it easy for you to find, book, and pay for your flight from Toronto to Cuba. Don’t stress the planning and avoid vacation debt by using the easy flight search feature on our website. To give you more insight, we’ve listed some of the airports you may be flying in and out of and some more flight booking tips below.
        </p>
      ...
      <div class="flex gap-4 lg:gap-8 mt-4 lg:mt-8 h-[500px]">
          ...
          <div id="carouselExampleCrossfade" class="carousel slide carousel-fade relative " data-bs-ride="carousel">
            ...
            <div class="carousel-inner relative w-full overflow-hidden rounded-lg ">
              <div class="carousel-item active float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/havana-2.jpg'?>"
              ...
              <div class="carousel-item float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/havana-1.jpg'?>"
                  class="block w-full object-cover object-center"
                  alt="Camera"
                />
              </div>
              <div class="carousel-item float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/havana-3.jpg'?>"
                  class="block w-full object-cover object-center"
                  alt="Exotic Fruits"
                />
              </div>
        ...
        <div class="flex-col sm:w-1/2 space-y-4 h-[500px]">
          ...
          <div class="flex justify-start items-center space-x-12">
            <?php echo do_shortcode("[location-weather id='11335']"); ?>
