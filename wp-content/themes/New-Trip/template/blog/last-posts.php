<div class="col-span-12 lg:col-span-9">
    ...
    <div class="flex-1 sm:flex space-x-0 sm:space-x-6 my-2 sm:my-4 px-4 whitespace-nowrap overflow-x-scroll overflow-hidden">
        ...
        <a href="<?php echo get_category_link($catID) ?>"
                class="inline-flex justify-center items-center rounded-full border font-semibold focus:outline-none px-3 py-1 text-xs focus:ring focus:ring-gray-500 focus:ring-opacity-25 bg-white text-pblue-800 hover:bg-pblue-800 hover:text-white">
    ...
    <div class="space-y-4 container xl:max-w-7xl mx-auto px-4 py-8 lg:py-8">
        <div class="space-y-4 sm:space-y-10">
            ...
            <div class="flex flex-col md:flex-row items-center bg-white rounded-lg overflow-hidden shadow-sm border">
                ...
                <div class="w-full lg:w-[64%] p-6 lg:py-6 lg:px-8"><h4
                        class="font-bold text-lg sm:text-xl mb-2 line-clamp-1"><a
                            href="<?php the_permalink() ?>" class="text-gray-800 hover:text-gray-600">
                           <?php the_title() ?>
                        </a></h4>
                    ...
                    <div class="mt-6 flex items-center justify-between">
                        <div class="inline-flex flex-shrink-0">
                            ...
                            <div ><p class="text-sm font-medium text-gray-900"><a
                                         class="hover:underline"><?php the_author() ?></a></p>
                                <div class="flex space-x-1 text-xs text-gray-500">
                                    <time datetime="2020-03-16"><?php the_time('M j , Y') ?></time>
                                    <span aria-hidden="true">· </span></div>
                            </div>
                        </div>
                        <div class="place-self-end"><a href="<?php the_permalink() ?>"
                                                       class="text-sm font-medium text-slate-900 hover:text-rose-600">
                                <div class="p-2 bg-gray-100 rounded-full md:px-8">Read more<span
                                        aria-hidden="true" class="ml-1">→</span></div>
                            </a></div>
                    </div>
                </div>
            </div>
