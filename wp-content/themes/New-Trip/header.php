                ...
                <div class="bg-gray-900">
                    <div class="covid max-w-7xl lg:mx-auto py-2 px-4 flex items-center justify-between">
                        <div class="hidden lg:flex">
                            ...
                            >All air passengers must comply with COVID-19 travel and vaccination requirements imposed by the
                        ...
                        <div class="flex flex-1 items-center justify-end space-x-6">
                            <a href="javascript:void(0)" class="-m-3 p-3 flex items-center">
                                <svg
                                    class="sm:hidden flex-shrink-0 h-4 w-4 text-gray-100"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                ...
                                <a
                                    ...
                                    class="ml-4 sm:text-xz text-xs font-medium text-white hover:text-gray-100"
                    ...
                    <div class="d-flex flex-wrap justify-between items-center">
                        <div class="flex pl-4">
                            ...
                            <div class="hidden lg:flex items-center gap-1 px-4">
                                <div class="hidden md:ml-6 lg:flex md:space-x-8 main-menu">
                                    <a href="<?php echo home_url() ?>/flights" class="text-tiny inline-flex items-center px-1 pt-1 sm:ml-4 hover:text-rose-600 text-gray-900 font-semibold" >
                                        Flights
                                    </a>
                                    <a href="<?php echo home_url() ?>/vacations" class="text-tiny inline-flex items-center px-1 pt-1 sm:ml-4 hover:text-rose-600 text-gray-900 font-semibold">
                                        Vacations
                                    </a>
                                    <a href="<?php echo home_url() ?>/hotels" class="text-tiny inline-flex items-center px-1 pt-1 sm:ml-4 hover:text-rose-600 text-gray-900 font-semibold">
                                        Hotels
                                    </a>
                                    <?php
                                    /*                                wp_nav_menu(
                                                                        array (
                                                                            ...
                                                                            'container_class' => 'hidden md:ml-6 lg:flex md:space-x-8', //parent container Class
                                                                            'depth' => 1,
                        ...
                        <div class="inline-flex items-center py-2 text-sm text-gray-900 rounded-lg lg:hidden pr-4">
                            ...
                            <div class="outclick" style="display: contents">
                                <button
                                    type="button"
                                    class="btn-menu-mobile inline-flex items-center justify-center ml-2 text-gray-900 hover:text-gray-700"
                                >
                                ...
                                <div
                                    class="menu-mobile w-[100vw] mx-auto bg-white text-tiny font-medium z-30 float-left py-2 list-none text-left rounded shadow-xl hidden"
                                >
                                    <div class="pt-2 pb-3 space-y-2">
                                        <a
                                            href="<?php echo home_url() ?>/flights"
                                            class="bg-pblue-50 border-rose-500 text-pblue-900 block pl-3 pr-4 py-2 border-l-4 text-tiny font-medium sm:pl-5 sm:pr-6"
                                        >Flights</a
                                        >
                                        <a
                                            href="<?php echo home_url() ?>/vacations"
                                            class="border-transparent text-slate-900 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-tiny font-medium sm:pl-5 sm:pr-6"
                                        >Vacations</a
                                        >
                                        <a
                                            href="<?php echo home_url() ?>/hotels"
                                            class="border-transparent text-slate-900 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-tiny font-medium sm:pl-5 sm:pr-6"
                                        >Hotels</a>
                        ...
                        <div class="hidden lg:flex items-center gap-1 sm:gap-8 px-6">
                            ...
                            <div class="flex-shrink-0">
                                <a href="<?php echo home_url() ?>/contact-us" class="text-slate-900 hover:text-rose-600 flex items-center"
                                ><svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="h-auto w-5 mr-0"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
                            ...
                            <div class="hidden md:ml-2 md:flex-shrink-0 md:flex md:items-center">
                                <button
                                    type="button"
                                    class="hidden bg-white p-1 rounded-full text-gray-800 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pblue-500"
                                ...
                                <div class="outclick" style="display: contents">
                                    <div class="mx-2 relative">
                                        ...
                                        <div
                                            class="bg-white text-base z-40 float-left py-2 list-none text-left rounded shadow-lg w-56 hidden"
                                        >
                                            <a
                                                href="javascript:void(0)"
