...
.nav-tabs {
  ...
  <section class="relative z-20 overflow-hidden px-4">
    <div class="container">
      <div class="d-flex d-flex-wrap">
        <div class="w-full">
          <h1 class="text-xl tracking-tight font-extrabold text-slate-900 sm:text-2xl md:text-3xl"> 
            <span class="block xl:inline">About Santo Domingo, <?php the_title(); ?></span>
          </h1>
        </div>
      </div>
      <div class="max-w-5xl py-4 prose">
        <p>
          The Dominican Republic is home to some of the most luxurious resorts and most adventurous wildlife retreats. There’s plenty to explore among the rainforests, mountains, and landscape beaches. There’s a reason it’s the most visited country in the Caribbean. Taking a trip to the Dominican Republic offers an adventure for tourists of all different interests. Foodies, adrenaline seekers, and outdoor lovers, listen up. We’ve listed below some of the best things to do, see and places to stay on your Dominican Republic vacation. Book your trip with us and we can help you even more along the way.
        </p>
      ...
      <div class="flex gap-4 lg:gap-8 mt-4 lg:mt-8 h-[500px]">
          ...
          <div id="carouselExampleCrossfade" class="carousel slide carousel-fade relative " data-bs-ride="carousel">
            ...
            <div class="carousel-inner relative w-full overflow-hidden rounded-lg ">
              <div class="carousel-item active float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/dominican-2.jpg'?>"
              ...
              <div class="carousel-item float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/dominican-1.jpg'?>"
                  class="block w-full object-cover object-center"
                  alt="Camera"
                />
              </div>
              <div class="carousel-item float-left w-full">
                <img
                  src="<?php echo THEME_IMAGE_DESTINATIONS.'/dominican-3.jpg'?>"
                  class="block w-full object-cover object-center"
                  alt="Exotic Fruits"
                />
              </div>
        ...
        <div class="flex-col sm:w-1/2 space-y-4 h-[500px]">
          ...
          <div class="flex justify-start items-center space-x-12">
            <?php echo do_shortcode("[location-weather id='11337']"); ?>

            <div class="font-normal text-lg flex items-center">
              <?php get_template_part('/partials/global/currency_svg')?> <span class="px-2">Currency</span>
