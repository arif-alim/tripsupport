<div class="relative bg-white overflow-hidden">
  <div class="max-w-7xl mx-auto">
    <div class="lg:pb-12 px-4">
      <div class="my-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <a href="<?php echo home_url() ?>/flights">
          <div class="flex group bg-pblue-700 p-4 transition ease-out duration-200 rounded-full gap-4 items-center w-full">
            <div class="inline-flex items-center justify-center relative">
              <svg class="ml-2 text-white relative transform transition ease-out duration-200 group-hover:scale-125 hi-outline hi-lightning-bolt inline-block w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke="none" aria-hidden="true">
            ...
            <div class="flex-col">
              <h4 class="text-lg font-medium text-white">
                Book your <span class="font-extrabold">Flight </span>now, pay later!
              </h4>
            </div>
          </div>
        </a>    
        ...
        <a href="<?php echo home_url() ?>/vacations">
          <div class="flex group bg-rose-600 p-4 transition ease-out duration-200 rounded-full gap-4 items-center w-full">
            <div class="inline-flex items-center justify-center relative">
              <svg class="ml-2 text-white relative transform transition ease-out duration-200 group-hover:scale-125 hi-outline hi-lightning-bolt inline-block w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke="none" aria-hidden="true">
            ...
            <div class="flex-col">
              <h4 class="text-lg font-medium text-white">
                Book your <span class="font-extrabold">Vacation </span>now, pay later!
              </h4>
            </div>
          </div>
        </a>

        <a href="<?php echo home_url() ?>/hotels">
          <div class="flex group bg-slate-700 p-4 transition ease-out duration-200 rounded-full gap-4 items-center w-full">
            <div class="inline-flex items-center justify-center relative">
              <svg class="ml-2 text-white relative transform transition ease-out duration-200 group-hover:scale-125 hi-outline hi-lightning-bolt inline-block w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" stroke="none" aria-hidden="true">
            ...
            <div class="flex-col">
              <h4 class="text-lg font-medium text-white">
                Book your <span class="font-extrabold">Hotel </span>now, pay later!
              </h4>
            </div>
          </div>
        </a>
